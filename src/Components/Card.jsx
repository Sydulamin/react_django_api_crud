    ...
    return (
        <div className="bg-gray-700 m-4 rounded-md w-[300px] h-[450px]">
            ...
            <div className="flex justify-center items-center space-x-6">
                ...
                <button onClick={handleUpdate} className="border rounded-md bg-green-700 text-white p-1 hover:bg-black  hover:shadow-sm hover:shadow-yellow-700">Update</button>
            </div>
        </div>
    ); 
};
